...
const Register = () => {
  ...
  const { register, googleSignIn, loading, error } = useAuthActions()
      ...
      <div className="auth-container">
        <div className="auth-card">
          <div className="auth-header">
            ...
            <p>Start creating your link-in-bio page today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="input-group">
              ...
              <div className="input-wrapper">
                <span className="input-prefix">orbil.ink/</span>
                <input
                  type="text"
                ...
                />
                {usernameStatus && (
                  <span className={`input-status ${usernameStatus}`}>
              ...
              {usernameStatus === 'taken' && (
                <span className="input-hint error">This username is already in use</span>
              )}
              {usernameStatus === 'available' && (
                <span className="input-hint success">Username available!</span>
              )}
            </div>
